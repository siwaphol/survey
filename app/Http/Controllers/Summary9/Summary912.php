...
{
    // ประกอบอาหารไฟฟ้า
    public static function report912_1()
    {
        set_time_limit(3600);
        ...
        * (if(sum(if(unique_key='param7' and option_id=81,1,0)) + if('param7'='',1,0) >0,1,0)) 
        ...
        return response()->download(storage_path('excel/'.$outputFile), 'ตารางสรุปหมวดประกอบอาหาร_ไฟฟ้า.xlsx');
    }

    // น้ำมันสำเร็จรูป
    public static function report912_2()
    {
        set_time_limit(3600);
...
// ==== น้ำมันสำเร็จรูป
        ...
        * param2 * param3
        ...
        return response()->download(storage_path('excel/'.$outputFile), 'ตารางสรุปหมวดประกอบอาหาร_น้ำมันสำเร็จรูป.xlsx');
    }

    // พลังงานดั้งเดิม
    public static function report912_3()
    {
        set_time_limit(3600);
