...
{
    public static $electricMenu = [
        1=>'หลอดไฟ', 2=>'หม้อหุงข้าวไฟฟ้า',3=>'เตาหุงต้มไฟฟ้า', 4=>'ไมโครเวฟ', 5=>'เตาอบไฟฟ้า', 6=>'กระติกน้ำร้อน', 7=>'กาต้มน้ำไฟฟ้า', 8=>'กระทะไฟฟ้า',9=>'เครื่องปิ้งขนมปัง',10=>'เครื่องทำแซนวิช',
        11=>'เตาบาร์บีคิวไฟฟ้า',12=>'โทรทัศน์',13=>'เครื่องเล่นแผ่น',14=>'คอมโป',15=>'ชุดโฮมเธียเตอร์',16=>'เครื่องเล่นวิทยุพกพา',17=>'คอมพิวเตอร์',18=>'เครื่องพิมพ์',19=>'โทรศัพท์มือถือ',20=>'แบตเตอรี่สำรอง',
        21=>'พัดลม',22=>'พัดลมดูดอากาศ',23=>'เครื่องฟอกอากาศ',24=>'เครื่องทำน้ำอุ่นไฟฟ้า',25=>'เครื่องดูดฝุ่น',26=>'เตารีดไฟฟ้า',27=>'ตู้เย็น',28=>'เครื่องปรับอากาศ',29=>'เครื่องซักผ้าและอบผ้า',30=>'ไดร์เป่าผม',
        31=>'เครื่องหนีบผม',32=>'จักรเย็บผ้าไฟฟ้า',33=>'เครื่องฉีดน้ำแรงดันสูง',34=>'ปั้มน้ำอัตโนมัติ',35=>'เครื่องดักแมลง',36=>'ไม้ตียุง'
    ];
    public static $fuelMenu = [
        1=>'เตาหุงต้มแก๊ส',2=>'เครื่องทำน้ำอุ่นแก๊ส',3=>'รถจักรยานยนต์',4=>'รถยนต์นั่งส่วนบุคคล',5=>'รถบรรทุกส่วนบุคคล',6=>'เครื่องยนต์ขนาดเล็ก',7=>'รถตัดหญ้า',8=>'เครื่องตัดหญ้าสะพายบ่า',9=>'ควายเหล็ก',10=>'รถอีแต๋น',11=>'รถแทรกเตอร์'
    ];
    public static $renewMenu = [
        1=>'เตาบาร์บีคิว',2=>'เตาอังโล่',3=>'เตาประสิทธิภาพสูง',4=>'เตาเศรษฐกิจ',5=>'เตาเหล็ก3ขา',6=>'เตาถาวร',7=>'เตาชั่วคราว',8=>'การสุ่มไฟ'
    ];
