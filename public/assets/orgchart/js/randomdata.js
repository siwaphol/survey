...
function GetNextPhoto() {
	...
	return "assets/orgchart/images/photos/" + photos[photoIndex] + ".png";
}
...
function getMatrixedLeaves() {
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: null,
        title: GetNextName(),
        description: "Description of id0 " + GetCurrentName(),
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: 0,
        title: GetNextName(),
        description: "Adviser Description id1",
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: 1,
        title: GetNextName(),
        description: "Assistant Description id2",
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: 1,
        title: GetNextName(),
        description: "Regular Description id3",
        image: "demo/images/photos/y.png",
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: 0,
        title: GetNextName(),
        description: "Adviser Description id4",
        image: "demo/images/photos/z.png",
        itemType: primitives.orgdiagram.ItemType.Adviser,
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: 0,
        title: GetNextName(),
        description: "Assitant Description id5",
        image: "demo/images/photos/y.png",
        itemType: primitives.orgdiagram.ItemType.Assistant,
        // adviserPlacementType: primitives.common.AdviserPlacementType.Left,
        phone: GetRandomPhone(),
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: 5,
        title: GetNextName(),
        description: "Assitant Description id6",
        image: "demo/images/photos/y.png",
        itemType: primitives.orgdiagram.ItemType.Assistant,
        adviserPlacementType: primitives.common.AdviserPlacementType.Right,
        phone: GetRandomPhone(),
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        parent: 5,
        title: GetNextName(),
        description: "Regular Description id7",
        image: "demo/images/photos/y.png",
        itemType: primitives.orgdiagram.ItemType.Regular,
        phone: GetRandomPhone(),
        email: GetRandomEmail("Regular"),
