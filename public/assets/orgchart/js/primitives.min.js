/*
 Basic Primitives orgDiagram v2.1.1
...
primitives.common.Connector.prototype.draw=function(a,b,c){var d,e,f,g,h,i,j,k,l,m=6*this.lineWidth,n,p,r=0,s=0,q,u=new primitives.common.PaletteItem({lineColor:this.color,lineWidth:this.lineWidth,lineType:this.lineType}),t=new primitives.common.PolylinesBuffer,v=t.getPolyline(u),a=(new primitives.common.Rect(a)).offset(this.offset),b=(new primitives.common.Rect(b)).offset(this.offset);i=[];switch(this.connectorShapeType){case 1:i=[-m/2,m/2];break;case 0:i=[0]}this.transform=new primitives.common.Transform;
...
e.x,f.height<f.width){f.height<2*m&&f.offset(0,l?2*m:0,0,l?0:2*m);g=0;for(h=i.length;g<h;g+=1)j=i[g],t.addInverted(function(a){a=a.getPolyline(u);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+j));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),(l?f.top():f.bottom())+j,e.x,e.y+j))},!g),v.addArrow(this.lineWidth,function(a,b){var c=t.getPolyline(b);c.segments=c.segments.concat(a)});i=n.width<2*(f.width/5)?primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,
d.y,f.horizontalCenter(),l?f.top():f.bottom(),e.x,e.y,0.5):new primitives.common.Point(d.x,l?f.top():f.bottom());p=new primitives.common.Rect(i.x+(k?m:-n.width-m),l?i.y-n.height-m:i.y+m,n.width,n.height)}else{g=0;for(h=i.length;g<h;g+=1)j=i[g],t.addInverted(function(a){a=a.getPolyline(u);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+j));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+j*(l!=k?1:-1),(l?f.top():f.bottom())+j,f.horizontalCenter()+j*(l!=k?1:-1),
f.verticalCenter()+j));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+j*(l!=k?1:-1),(l?f.bottom():f.top())+j,e.x,e.y+j))},!g),v.addArrow(this.lineWidth,function(a,b){var c=t.getPolyline(b);c.segments=c.segments.concat(a)});p=new primitives.common.Rect(f.horizontalCenter()+(l!=k?m:-(m+n.width)),f.verticalCenter()-n.height/2,n.width,n.height)}else if(a.verticalCenter()<b.top()||a.verticalCenter()>b.bottom()){k=a.x<q.width/2;d=new primitives.common.Point(k?a.right():a.left(),
a.verticalCenter());e=new primitives.common.Point(k?b.right():b.left(),b.verticalCenter());s=r=k?3:7;f=new primitives.common.Rect(d,e);f.offset(10*m,0,10*m,0);l=d.y<=e.y;g=0;for(h=i.length;g<h;g+=1)j=i[g],t.addInverted(function(a){a=a.getPolyline(u);a.segments.push(new primitives.common.MoveSegment(d.x,d.y+j));a.segments.push(new primitives.common.QuadraticArcSegment(k?f.right()+j*(l?-1:1):f.left()-j*(l?-1:1),f.verticalCenter(),k?b.right():b.left(),b.verticalCenter()-j))},!g),v.addArrow(this.lineWidth,
function(a,b){var c=t.getPolyline(b);c.segments=c.segments.concat(a)});i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,d.y,k?f.right():f.left(),f.verticalCenter(),e.x,e.y,0.5);p=new primitives.common.Rect(i.x+(k?m/2:-m/2-n.width),i.y-n.height/2,n.width,n.height)}else{d=new primitives.common.Point(a.horizontalCenter(),a.top());e=new primitives.common.Point(b.horizontalCenter(),b.top());s=r=1;f=new primitives.common.Rect(d,e);f.offset(0,7*m,0,0);k=d.x<e.x;g=0;for(h=i.length;g<h;g+=
1)j=i[g],t.addInverted(function(a){a=a.getPolyline(u);a.segments.push(new primitives.common.MoveSegment(d.x+j,d.y));a.segments.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),f.top()-j*(k?-1:1),b.horizontalCenter()-j,b.top()))},!g),v.addArrow(this.lineWidth,function(a,b){var c=t.getPolyline(b);c.segments=c.segments.concat(a)});i=primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x,d.y,f.horizontalCenter(),f.top(),e.x,e.y,0.5);p=new primitives.common.Rect(i.x-n.width/
2,i.y-(this.labelOffset+n.height),n.width,n.height)}t.transform(this.transform,!0);this.m_graphics.polylinesBuffer(t);if(this.hasLabel){switch(this.labelPlacementType){case primitives.common.ConnectorLabelPlacementType.From:p=this._getLabelPosition(a.x,a.y,a.width,a.height,p.width,p.height,this.labelOffset,r);break;case primitives.common.ConnectorLabelPlacementType.To:p=this._getLabelPosition(b.x,b.y,b.width,b.height,p.width,p.height,this.labelOffset,s)}this.transform.transformRect(p.x,p.y,p.width,
...
primitives.orgdiagram.BaseController.prototype._getNextLevelTreeItem=function(a,b){var c=a.actualPosition.horizontalCenter(),d,e,f,g,h=null,i=null,j,k,l,m=b?this._treeLevels.slice(a.level+1,this._treeLevels.length):this._treeLevels.slice(0,a.level).reverse();f=0;for(g=m.length;f<g;f+=1){k=m[f].treeItems;d=0;for(e=k.length;d<e;d+=1)if(l=this._visualTree(k[d]),1==l.actualVisibility)if(j=Math.abs(c-l.actualPosition.horizontalCenter()),j<i||null==i)i=j,h=l;else break;if(null!=i)break}return h};
...
!0,this,function(a,i,p,r){switch(f.actualVisibility){case 1:b=new primitives.common.RenderEventArgs;b.context=f.itemConfig;b.isCursor=f.isCursor;b.isSelected=f.isSelected;b.templateName=f.template.name;this.graphics.activate("placeholder",7);this.graphics.template(a,i,p,r,f.contentPosition.x,f.contentPosition.y,f.contentPosition.width,f.contentPosition.height,f.template.itemTemplate,f.template.itemTemplateHashCode,f.template.itemTemplateRenderName,b,{"border-width":f.template.itemBorderWidth});f.actualHasGroupTitle&&
this.graphics.template(a,i,p,r,2,f.contentPosition.y,this.options.groupTitlePanelSize-4,f.contentPosition.height+2,this._groupTitleTemplate,this._groupTitleTemplateHashCode,"onGroupTitleTemplateRender",f,null);f.actualHasSelectorCheckbox&&(this.graphics.activate("placeholder",10),this.graphics.template(a,i,p,r,f.contentPosition.x,f.actualSize.height-(this.options.checkBoxPanelSize-4),f.contentPosition.width,this.options.checkBoxPanelSize-4,this._checkBoxTemplate,this._checkBoxTemplateHashCode,"onCheckBoxTemplateRender",
f,null));f.actualHasButtons&&(this.graphics.activate("placeholder",10),this.graphics.template(a,i,p,r,f.actualSize.width-(this.options.buttonsPanelSize-4),f.contentPosition.y,this.options.buttonsPanelSize-4,Math.max(f.contentPosition.height,f.actualSize.height-f.contentPosition.y),this._buttonsTemplate,f.template.name+this._buttonsTemplateHashCode,"onButtonsTemplateRender",f,null));0==this.options.showLabels&&(h=new primitives.common.Label,h.text=g.title,h.position=new primitives.common.Rect(a,i,
p,r),h.weight=1E4,h.labelType=1,l.labels.push(h));break;case 2:c=g.itemTitleColor;null==c&&(c="#000080");d.hasOwnProperty(c)||(d[c]=[]);e=d[c];e.push(new primitives.common.DotSegment(a,i,p,r,f.template.minimizedItemCornerRadius));h=this._createLabel(a,i,p,r,f);null!=h&&l.labels.push(h);break;default:this._debug&&(c="#ff0000",d.hasOwnProperty(c)||(d[c]=[]),e=d[c],e.push(new primitives.common.DotSegment(a-1,i-1,2,2,1)))}})});this.graphics.activate("placeholder",4);for(c in d)d.hasOwnProperty(c)&&(e=
...
primitives.orgdiagram.BaseController.prototype._tracePathAnnotations=function(){var a,b,c,d,e,f,g,h,i,j,k,l;a=0;for(b=this.options.annotations.length;a<b;a+=1)switch(c=this.options.annotations[a],c.annotationType){case 2:if(null==i&&(i=this._getConnectionsGraph()),null!=c.items&&0<c.items.length&&(k=c.items.slice(0),e=this._treeItemsByUserId[k[0]],null!=e&&(1==k.length&&this._navigationFamily.loopParents(this,e.id,function(a,b){null!=b.itemConfig&&k.push(b.itemConfig.id);return this._navigationFamily.SKIP}),
1<k.length))){c=1;for(d=k.length;c<d;c+=1)if(g=this._treeItemsByUserId[k[c]],null!=g){j=i.getShortestPath(e.id,g.id,function(a,b,c){return a.getNear(c)});e=1;for(f=j.length;e<f;e+=1)l=i.edge([j[e-1]],[j[e]]),h=this._visualTree.node(l.highlightItemId),h.highlightPath=1,l.hasOwnProperty("partnerid")&&(h=this._visualTree.node(l.partnerid),h.partnerHighlightPath=1);e=g}}}};
primitives.orgdiagram.BaseController.prototype._getConnectionsGraph=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m=primitives.common.graph();b=0;for(c=this._treeLevels.length;b<c;b+=1){a=this._treeLevels[b];d=0;for(e=a.treeItems.length;d<e;d+=1){h=a.treeItems[d];h=this._visualTree.node(h);j=h.actualIsActive?100:1;h.connectorPlacement&8?k=[a.treeItems[h.levelPosition-1]]:h.connectorPlacement&2?k=[a.treeItems[h.levelPosition+1]]:h.connectorPlacement&1?(f=this._visualTree.parent(h.id),k=1<f.partners.length?
f.partners.slice(0):[f.id],0<f.extraPartners.length&&(k=k.concat(f.extraPartners))):k=[];f=0;for(g=k.length;f<g;f+=1)l=k[f],i=this._visualTree.node(l),i=i.actualIsActive?100:1,i=new primitives.famdiagram.EdgeItem(h.id,j,l,i),i.highlightItemId=h.id,1!=g&&(i.partnerid=l),m.addEdge(h.id,l,i)}}return m};
...
g=new primitives.common.Perimeter(this.graphics);g.transform=this.transform;h=new primitives.orgdiagram.BackgroundAnnotationConfig;k="opacity lineWidth borderColor fillColor lineType zOrderType".split(" ");a=0;for(d=k.length;a<d;a+=1)l=k[a],g[l]=m.hasOwnProperty(l)?m[l]:h[l];switch(g.zOrderType){case 2:a=8;break;case 1:a=1;break;default:a=1}a=this.graphics.activate("placeholder",a);i=[];j={};if(m.includeChildren){a=0;for(d=m.items.length;a<d;a+=1)h=m.items[a],e=this._treeItemsByUserId[h],null!=e&&
(j[e.orgItem.id]=!0,i.push(e.orgItem.id),this._navigationFamily.loopChildren(this,e.id,function(a,b){null!=b.orgItem&&!j[b.orgItem.id]&&(j[b.orgItem.id]=!0,i.push(b.orgItem.id))}))}else i=m.items;m=p.getMergedPerimeters(i);for(a=0;a<m.length;a+=1)g.draw(m[a])}}};
primitives.orgdiagram.BaseController.prototype._getBackgroundManager=function(){var a=new primitives.common.perimeter.Manager,b,c,d,e,f,g,h,i,j,k,l;if(0<this._treeLevels.length){i=[];f=[];b=0;for(c=this._treeLevels.length;b<c;b+=1)if(h=j=null,d=this._treeLevels[b],4!=d.actualVisibility){i.push(b);g=[];k=d.treeItems;d=0;for(e=k.length;d<e;d+=1)l=this._visualTree.node(k[d]),4!=l.actualVisibility&&null!=l.orgItem&&(null!=h&&this._addOffset(g,j,h,l),j=h,h=l);null!=h&&this._addOffset(g,j,h,null);f.push(g)}if(0<
f.length){j=[];g=[];b=0;for(c=f.length;b<c;b+=1)g=primitives.common.mergeSort([g,f[b]],null,!0),j.push(g),g=f[b];j.push(primitives.common.mergeSort([f[b-1]],null,!0));f=[];b=0;for(c=j.length;b<c;b+=1){h={};g=j[b];d=0;for(e=g.length;d<e;d+=1)k=g[d],h[k]=d;f.push(h)}h=[];d=g=null;b=0;for(c=i.length;b<c;b+=1)e=this._treeLevels[i[b]],null!=d&&this._addTreeLevelPerimeters(h,b-1,f,j,g,d,e),g=d,d=e;null!=d&&this._addTreeLevelPerimeters(h,b-1,f,j,g,d,null);a.add(h)}}return a};
primitives.orgdiagram.BaseController.prototype._addTreeLevelPerimeters=function(a,b,c,d,e,f,g){var h=Math.floor(this.options.normalItemsInterval/2),e=null!=e?Math.floor(3*(e.shift+e.depth)/7+4*f.shift/7):f.shift-h,g=null!=g?Math.floor(3*(f.shift+f.depth)/7+4*g.shift/7):f.shift+f.depth+h,i=h=null,j=f.treeItems,k,l;k=0;for(l=j.length;k<l;k+=1)f=this._visualTree.node(j[k]),4!=f.actualVisibility&&null!=f.orgItem&&(null!=i&&this._addPerimeter(a,c[b],c[b+1],d[b],d[b+1],e,g,h,i,f),h=i,i=f);null!=i&&this._addPerimeter(a,
...
primitives.orgdiagram.BaseController.prototype._redrawConnectors=function(){var a=this.graphics.activate("placeholder",2),b,c,d,e,f,g,h,i;if(this._visualTree.hasNodes()){e=new primitives.common.PaletteManager(this.options);f=new primitives.common.PolylinesBuffer;for(i=0;i<this._treeLevels.length;i+=1){d=this._treeLevels[i];c=d.treeItems;g=0;for(h=c.length;g<h;g+=1)b=this._visualTree.node(c[g]),this._redrawConnector(a.hasGraphics,f,e,b,d)}this.graphics.polylinesBuffer(f)}};
primitives.orgdiagram.BaseController.prototype._redrawConnector=function(a,b,c,d,e){var f=this,g,h,i,j,k,l,m,n,p,r,s,q,u,t=0,v,w=0==this.options.connectorType,x,z;u=0<d.partnerConnectorOffset?e.shift+e.connectorShift-e.levelSpace/2*(e.partnerConnectorOffset-d.partnerConnectorOffset+1):d.connectorPlacement&4?d.actualPosition.bottom():e.shift+e.connectorShift;1>=d.partnerConnectorOffset?c.selectPalette(0):1<d.partnerConnectorOffset?c.selectPalette(d.partnerConnectorOffset-1):c.selectPalette(e.partnerConnectorOffset);
this._visualTree.hasChildren(d.id)&&(g=4===d.actualVisibility&&null==this._visualTree.parentid(d.id),q=d.actualPosition.horizontalCenter());i=[];if(1<d.partners.length||0<d.extraPartners.length){j=d.partners;for(m=0;m<j.length;m+=1)k=this._visualTree.node(j[m]),v=new primitives.orgdiagram.ConnectorPoint(k.actualPosition.horizontalCenter(),k.actualPosition.bottom()),v.isSquared=!0,v.highlightPath=k.partnerHighlightPath,v.connectorStyleType=k.partnerHighlightPath?2:1,v.visibility=k.actualVisibility,
i.push(v);j=d.extraPartners;for(m=0;m<j.length;m+=1)k=this._visualTree.node(j[m]),v=new primitives.orgdiagram.ConnectorPoint(k.actualPosition.horizontalCenter(),k.actualPosition.bottom()),v.isSquared=!0,v.highlightPath=k.partnerHighlightPath,v.connectorStyleType=k.partnerHighlightPath?2:0,v.visibility=k.actualVisibility,i.push(v);0<i.length&&(i.sort(function(a,b){return a.x-b.x}),this._visualTree.hasChildren(d.id)||(q=(i[0].x+i[i.length-1].x)/2),b.addInverted(function(b){f._drawTopConnectors(b,c,
q,u,i,!0,a,1==f.options.arrowsDirection)}))}h=[];this._visualTree.hasChildren(d.id)&&(s=!1,this._visualTree.loopChildren(this,d.id,function(d,e){l=this._treeLevels[e.level];x=c.getPalette(e.highlightPath?2:1);z=b.getPolyline(x);if(e.connectorPlacement&8)n=this._visualTree.node(l.treeItems[e.levelPosition-1]),this.transform.transformPoints(e.actualPosition.x,e.actualPosition.verticalCenter(),n.actualPosition.right(),e.actualPosition.verticalCenter(),!0,this,function(a,c,d,g){f._drawLineWithArrow(a,
c,d,g,b,z,e.actualVisibility,n.actualVisibility)});else if(e.connectorPlacement&2)p=this._visualTree.node(l.treeItems[e.levelPosition+1]),this.transform.transformPoints(e.actualPosition.right(),e.actualPosition.verticalCenter(),p.actualPosition.x,e.actualPosition.verticalCenter(),!0,this,function(a,c,d,g){f._drawLineWithArrow(a,c,d,g,b,z,e.actualVisibility,p.actualVisibility)});else if(e.connectorPlacement&1&&!g){r=!0;if(a)switch(e.actualVisibility){case 2:case 3:r=w}v=new primitives.orgdiagram.ConnectorPoint(e.actualPosition.horizontalCenter()+
0,e.actualPosition.top());v.isSquared=r;v.connectorStyleType=e.highlightPath?2:1;v.visibility=e.actualVisibility;h.push(v);t=Math.max(t,v.connectorStyleType);s=s||v.isSquared}}),!g&&0<h.length&&(this.transform.transformPoints(q,u,q,e.shift+e.connectorShift,!0,this,function(a,e,g,j){var k=Math.round(f.options.elbowDotSize/2),l=c.getPalette(t),m=b.getPolyline(l),m=b.getPolyline(m.arrowPaletteItem);this.showElbowDots&&(0!=this.options.elbowType&&0<d.partners.length)&&m.segments.push(new primitives.common.DotSegment(a-
k,e-k,2*k,2*k,k));b.addInverted(function(c){c=c.getPolyline(l);c.segments.push(new primitives.common.MoveSegment(g,j));c.segments.push(new primitives.common.LineSegment(a,e));1==f.options.arrowsDirection&&(4!=d.visibility&&1>=i.length)&&c.addArrow(f.options.linesWidth,function(a,c){var d=b.getPolyline(c);d.segments=d.segments.concat(a)})});this.showElbowDots&&(0!=this.options.elbowType&&1<h.length)&&m.segments.push(new primitives.common.DotSegment(g-k,j-k,2*k,2*k,k))}),this._drawTopConnectors(b,c,
q,e.shift+e.connectorShift,h,s,a,2==this.options.arrowsDirection)))};
...
primitives.orgdiagram.BaseController.prototype._drawTopConnectors=function(a,b,c,d,e,f,g,h){var i,j,k,l=[],m,n,p,r=this;if(f){l=[];f=0;for(j=e.length;f<j;f+=1)if(k=e[f],k.x<c&&!k.isSquared)l.push(k);else break;j=l.length;0<j&&this._drawAngularConnectors(a,b,c,d,l,!1,h);l=[];for(i=e.length-1;i>=f;i-=1)if(k=e[i],k.x>c&&!k.isSquared)l.push(k);else break;j=l.length;0<j&&this._drawAngularConnectors(a,b,c,d,l,!1,h);l={};j={};for(n in primitives.common.ConnectorStyleType)primitives.common.ConnectorStyleType.hasOwnProperty(n)&&
(l[primitives.common.ConnectorStyleType[n]]=c,j[primitives.common.ConnectorStyleType[n]]=c);for(n=f;n<=i;n+=1){k=e[n];m=b.getPalette(k.connectorStyleType);p=a.getPolyline(m);m=this.options.dotItemsInterval/2;2>m&&(m=0);if(g)switch(this.options.elbowType){case 2:case 3:0<m&&(Math.abs(c-k.x)>m&&Math.abs(d-k.y)>m)&&(k.hasElbow=!0,k.elbowPoint1=new primitives.common.Point(k.x,d+(d>k.y?-m:m)),k.elbowPoint2=new primitives.common.Point(k.x+(c>k.x?m:-m),d));break;case 1:0<i-f&&this.transform.transformPoints(k.x,
d,k.x,k.y,!0,this,function(b,c){var d=Math.round(r.options.elbowDotSize/2);a.getPolyline(p.arrowPaletteItem).segments.push(new primitives.common.DotSegment(b-d,c-d,2*d,2*d,d))})}l[k.connectorStyleType]=Math.min(l[k.connectorStyleType],k.hasElbow?k.elbowPoint2.x:k.x);j[k.connectorStyleType]=Math.max(j[k.connectorStyleType],k.hasElbow?k.elbowPoint2.x:k.x)}m=[Math.max(0,f-1),Math.min(i+1,e.length-1)];for(n=0;n<m.length;n+=1)k=e[m[n]],l[k.connectorStyleType]=Math.min(l[k.connectorStyleType],k.hasElbow?
k.elbowPoint2.x:k.x),j[k.connectorStyleType]=Math.max(j[k.connectorStyleType],k.hasElbow?k.elbowPoint2.x:k.x);k=c;for(n=2;0<=n;n-=1)m=b.getPalette(n),p=a.getPolyline(m),m=l[n],null!=m&&m<k&&(this.transform.transformPoints(k,d,m,d,!0,this,function(a,b,c,d){p.segments.push(new primitives.common.MoveSegment(a,b));p.segments.push(new primitives.common.LineSegment(c,d))}),k=m),m=j[n],null!=m&&m>c&&(this.transform.transformPoints(c,d,m,d,!0,this,function(a,b,c,d){p.segments.push(new primitives.common.MoveSegment(a,
b));p.segments.push(new primitives.common.LineSegment(c,d))}),c=m);for(n=f;n<=i;n+=1)k=e[n],m=b.getPalette(k.connectorStyleType),p=a.getPolyline(m),k.hasElbow?(this.transform.transform3Points(k.elbowPoint2.x,k.elbowPoint2.y,k.elbowPoint1.x,k.elbowPoint2.y,k.elbowPoint1.x,k.elbowPoint1.y,!0,this,function(a,b,c,d,e,f){switch(this.options.elbowType){case 2:p.segments.push(new primitives.common.MoveSegment(a,b));p.segments.push(new primitives.common.LineSegment(e,f));break;case 3:p.segments.push(new primitives.common.MoveSegment(a,
...
primitives.orgdiagram.BaseController.prototype._setOffset=function(a){var b=this._treeLevels[a.level],c=this._itemsInterval[0===a.visibility?b.currentvisibility:a.visibility]/2,d,e,f,g,h,i,j,k,l;i=8*this.options.linesWidth;a.leftPadding=c+(0<b.currentOffset?c*a.relationDegree*this.options.cousinsIntervalMultiplier:0);a.rightPadding=c;0!=this.options.arrowsDirection&&(a.connectorPlacement&8&&(a.leftPadding+=i),a.connectorPlacement&2&&(a.rightPadding+=i));a.offset=b.currentOffset+a.leftPadding;b.currentOffset=
...
!0}),0<e.length))){i=null;if(null!==h){j=[h];j=j.concat(e);j.push(a);i=[[h]];c=1;for(d=j.length;c<d;c+=1)k=j[c-1],l=j[c],2==k.gravity||1==l.gravity?i[i.length-1].push(l):i.push([l])}else i=[e.slice(0)],i[i.length-1].push(a);if(0<i.length){e=i[i.length-1];for(c=e.length-2;0<=c;c-=1)l=e[c],g=f[l.id],b=Math.min(g,b),this._offsetItem(l,b),this._offsetItemChildren(l,b)}j=b/(i.length-1);for(d=i.length-2;0<d;d-=1){k=i[d];for(c=k.length-1;0<=c;c-=1)l=k[c],g=f[l.id],b=Math.min(d*j,Math.min(g,b)),this._offsetItem(l,
...
primitives.orgdiagram.BaseController.prototype._createVisualTreeItems=function(){var a,b,c,d,e,f,g,h,i,j,k,l,m={},n,p={},r,s,q,u={},t;this._orgTree.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});this._orgTree.loopLevels(this,function(c,g){var h,i,j;if(!this.showInvisibleSubTrees&&!g.hasVisibleChildren)return this._orgTree.SKIP;h=this._treeItemsByUserId[c];h||(h=this._getNewTreeItem({visibility:4,
connectorPlacement:0,parentId:null,orgItem:g,itemConfig:null,actualItemType:0}),this._visualTree.add(null,h.id,h));q=s=0;if(null!=(f=this._visualTree.indexOf(h.id)))s=f,q=this._visualTree.countSiblings(h.id)-f-1;i=[];this._orgTree.loopChildren(this,c,function(c,f){if(this.showInvisibleSubTrees||f.hasVisibleChildren){a=this._getNewTreeItem({orgItem:f,itemConfig:f.context,parentId:h.id,actualItemType:f.itemType});a.visibility=!a.orgItem.isVisible?4:0;switch(h.actualItemType){case 7:case 8:case 6:switch(a.actualItemType){case 7:case 8:case 6:a.actualItemType=
2;break;case 0:a.actualItemType=1}}switch(a.actualItemType){case 5:this._defineNavigationParent(h,a),a.connectorPlacement=5,j=this._getNewTreeItem({visibility:4}),this._visualTree.add(j.id,a.id,a),a=j;case 8:case 2:b=this._visualTree.parent(h.id);if(h.connectorPlacement&2)d=this._findLeftSiblingIndex(h),this._visualTree.add(b.id,a.id,a,d+1),a.connectorPlacement=6,a.gravity=2;else if(h.connectorPlacement&8)e=this._findRightSiblingIndex(h),this._visualTree.add(b.id,a.id,a,e),a.connectorPlacement=12,
a.gravity=1;else switch(f.adviserPlacementType){case 2:d=this._findLeftSiblingIndex(h);this._visualTree.add(b.id,a.id,a,d+1);a.connectorPlacement=6;a.gravity=2;break;default:e=this._findRightSiblingIndex(h),this._visualTree.add(b.id,a.id,a,e),a.connectorPlacement=12,a.gravity=1}switch(a.actualItemType){case 8:null!=h.parentId?this._defineNavigationParent(this._visualTree.node(h.parentId),a):this._defineNavigationParent(h,a,!0);break;case 2:this._defineNavigationParent(h,a)}break;case 4:this._defineNavigationParent(h,
a),a.connectorPlacement=5,j=this._getNewTreeItem({visibility:4}),this._visualTree.add(j.id,a.id,a),a=j;case 1:null===h.visualAggregatorId&&this._createNewVisualAggregator(h);switch(f.adviserPlacementType){case 2:this._visualTree.add(h.id,a.id,a,0);a.connectorPlacement=6;a.gravity=2;break;default:this._visualTree.add(h.id,a.id,a),a.connectorPlacement=12,a.gravity=1}1==a.actualItemType&&this._defineNavigationParent(h,a);break;case 0:i.push(a);this._defineNavigationParent(h,a);break;case 7:case 6:b=
this._visualTree.parent(h.id);if(h.connectorPlacement&2)this._visualTree.add(b.id,a.id,a,s),a.connectorPlacement=6,a.gravity=2;else if(h.connectorPlacement&8)this._visualTree.add(b.id,a.id,a,this._visualTree.countChildren(b.id)-q),a.connectorPlacement=12,a.gravity=1;else{switch(f.adviserPlacementType){case 2:this._visualTree.add(b.id,a.id,a,s);a.gravity=2;break;default:this._visualTree.add(b.id,a.id,a,this._visualTree.countChildren(b.id)-q),a.gravity=1}switch(a.actualItemType){case 6:a.connectorPlacement=
5;break;case 7:a.connectorPlacement=4}}null!=h.parentId?this._defineNavigationParent(this._visualTree.node(h.parentId),a):this._defineNavigationParent(h,a,!0)}}});switch(h.actualItemType){case 7:case 8:case 6:break;default:t=[],null!=(b=this._visualTree.parent(h.id))&&this._visualTree.loopChildrenRange(this,b.id,s,this._visualTree.countChildren(b.id)-q,function(a,b){if(b.id==h.id)t.push(b);else switch(b.actualItemType){case 7:case 8:case 6:this._orgTree.parentid(b.orgItem.id)==h.orgItem.id&&t.push(b)}}),
1<t.length&&(u[h.id]=t)}m[h.id]=[];p[h.id]=[];this._layoutChildren(h,i,h.orgItem.childrenPlacementType,m[h.id],p[h.id])});this._orgTree.loopPostOrder(this,function(a){var a=this._treeItemsByUserId[a],b=p[a.id],d=m[a.id];if(null!=a){j=this._getAssitantsDepth(a);if(0<j&&(a.visualDepth=j+1,null!==a.visualAggregatorId&&(c=this._visualTree.node(a.visualAggregatorId),this._visualTree.hasChildren(c.id))))for(f=0;f<j-1;f+=1)c=this._createNewVisualAggregator(c);j=this._getAdvisersDepth(a);if(1<j&&(a.visualDepth+=
j-1,this._visualTree.hasChildren(a.id))){c=a;for(f=0;f<j-1;f+=1)c=this._createNewVisualAggregator(c)}k=[];f=0;for(g=b.length;f<g;f+=1){r=b[f];h=k[f]=0;for(i=r.length;h<i;h+=1)k[f]=Math.max(k[f],this._getItemDepth(r[h]))}f=0;for(g=k.length;f<g;f+=1)if(l=k[f],1<l){h=0;for(i=d[f].length;h<i;h+=1)if(n=d[f][h],this._visualTree.hasChildren(n.id))for(j=l;1<j;)n=this._createNewVisualAggregator(n),j-=1}null!=u[a.id]&&this._layoutPartners(a,u[a.id])}})};
primitives.orgdiagram.BaseController.prototype._layoutPartners=function(a,b){var c,d,e,f,g=0,h=[],i,j;d=0;for(e=b.length;d<e;d+=1)c=b[d],g=Math.max(g,c.visualDepth);d=0;for(e=b.length;d<e;d+=1){c=b[d];i=this._getLastVisualAggregator(c);for(f=this._getLastVisualAggregatorDepth(c);f<g;)i=this._createNewVisualAggregator(i),f+=1;h.push(this._getLastVisualAggregator(i).id)}j=this._getLastVisualAggregator(a);if(this._visualTree.hasChildren(j.id)){i=b[Math.floor(b.length/2)];if(1<b.length&&0==b.length%2){d=
this._visualTree.parent(i.id);e=this._findLeftSiblingIndex(i);f=this._visualTree.getChild(d.id,e).gravity||this._visualTree.getChild(d.id,e+1).gravity;i=this._getNewTreeItem({visibility:4,connectorPlacement:i.connectorPlacement&10,gravity:f});this._visualTree.add(d.id,i.id,i,e+1);for(f=1;f<g;)i=this._createNewVisualAggregator(i),i.connectorPlacement=0,f+=1}d=0;for(e=b.length;d<e;d+=1)c=b[d],this._navigationFamily.loopChildren(this,a.id,function(b,d){switch(d.actualItemType){case 5:case 2:case 4:case 1:break;
default:a.id!=c.id&&this._defineNavigationParent(c,d)}return this._navigationFamily.SKIP});i=this._getLastVisualAggregator(i);this._visualTree.moveChildren(j.id,i.id)}i.partners=h;a.partnerAggregatorId=i.id};primitives.orgdiagram.BaseController.prototype._defineNavigationParent=function(){};primitives.orgdiagram.BaseController.prototype._getLastVisualAggregatorDepth=function(a){for(var b=0;null!=a.visualAggregatorId;)a=this._visualTree.node(a.visualAggregatorId),b+=1;return b+1};
...
primitives.orgdiagram.BaseController.prototype._layoutChildren=function(a,b,c,d,e){var f,g,h,i,j,k,l,m,n=4==a.visibility&&0==a.connectorPlacement;switch(this.options.horizontalAlignment){case 0:case 1:g=3;break;case 2:g=2}0===c&&(c=this._hasRegularLeavesOnly(this._orgTree,a)?0===this.options.leavesPlacementType?3:this.options.leavesPlacementType:0===this.options.childrenPlacementType?2:this.options.childrenPlacementType);f=a;null!==a.visualAggregatorId&&(f=this._visualTree.node(a.visualAggregatorId));
3==c&&3>b.length&&(c=2);switch(c){case 2:c=0;for(i=b.length;c<i;c+=1)a=b[c],this._visualTree.add(f.id,a.id,a),a.connectorPlacement=(a.orgItem.hideParentConnection?0:1)|(a.orgItem.hideChildrenConnection?0:4),0==c&&(a.relationDegree=1);break;case 3:i=Math.min(this.options.maximumColumnsInMatrix,Math.ceil(Math.sqrt(b.length)));j=Math.ceil(b.length/i);k=Math.ceil(i/2);for(l=0;l<k;l+=1){g=f;for(m=0;m<j;m+=1){a=this._getMatrixItem(b,2*l,m,i);c=this._getMatrixItem(b,2*l+1,m,i);void 0===d[m]&&(d[m]=[],e[m]=
[]);null!==a&&(0==l&&(a.relationDegree=1),this._visualTree.add(g.id,a.id,a),a.connectorPlacement=(n?0:2)|4,a.gravity=2,e[m].push(a));if(null!==a||null!==c)h=this._getNewTreeItem({visibility:4,connectorPlacement:n?0:5}),this._visualTree.add(g.id,h.id,h),d[m].push(h);null!==c&&(this._visualTree.add(g.id,c.id,c),c.connectorPlacement=(n?0:8)|4,c.gravity=1,e[m].push(c));g=h}}2<i&&(f.visualAggregatorId=null);break;case 1:c=0;for(i=b.length;c<i;c+=1){a=b[c];h=this._getNewTreeItem({visibility:4,connectorPlacement:n?
...
primitives.common.perimeter.LinkedHashItems=function(){this.segmentsHash={};this.nextKeys={};this.prevKeys={};this.endSegmentKey=this.startSegmentKey=null};
...
primitives.common.mergeSort=function(a,b,c){var d=null,e,f,g,h,i,j,k,l,m,n,p,r;switch(a.length){case 0:d=[];break;default:d=[];for(g=0;g<a.length;g+=1){e=a[g];f=[];j=d.length;k=e.length;i=h=0;p=m=n=l=null;0<j&&(l=d[h],n=!b?l:b(l));0<k&&(m=e[i],p=!b?m:b(m));for(r=null;h<j||i<k;)if(h>=j){if(!c||r!=m)f.push(m),r=m;i+=1;i<k&&(m=e[i],p=!b?m:b(m))}else if(i>=k){if(!c||r!=l)f.push(l),r=l;h+=1;h<j&&(l=d[h],n=!b?l:b(l))}else if(n<p){if(!c||r!=l)f.push(l),r=l;h+=1;h<j&&(l=d[h],n=!b?l:b(l))}else{if(!c||r!=m)f.push(m),
r=m;i+=1;i<k&&(m=e[i],p=!b?m:b(m))}d=f}}return d};
primitives.common.stackSegments=function(a,b){var c=0,d,e,f,g,h,i,j,k=[],l,m,n,p,r,s,q={};a.sort(function(a,b){return a.endIndex-a.startIndex-(b.endIndex-b.startIndex)});g=0;for(h=a.length;g<h;g+=1){f=a[g];e=d=0;n=f.startIndex;q[n]=d+1;p=f.endIndex;q[p]=e;j=k.length;if(0<j){l=[];s=r=!1;for(i=0;i<j;i+=1)m=k[i],m<n?(l.push(m),d=q[m],e=q[m]):m<p?(r||(l.push(n),r=!0),d=Math.max(d,q[m]),e=q[m]):(r||(l.push(n),r=!0),s||(l.push(p),s=!0,q[n]=d+1,q[p]=e),l.push(m));r||(l.push(n),r=!0);s||(l.push(p),s=!0,q[n]=
...
primitives.common.family=function(){function a(a,b,c,d){var e;if(null!=d&&(b=b[c],null!=b))for(e in b)if(b.hasOwnProperty(e)&&d.call(a,e))break}function b(a,b){var c=!1;null!=s[a]&&null!=s[a][b]&&(delete s[a][b],q[a]-=1,delete u[b][a],t[b]-=1,q[a]||(delete s[a],delete q[a]),u[b]||(delete u[b],delete t[b],null==p[null]&&(p[null]={},r[null]=0),p[null][b]=!0,r[null]+=1),c=!0);return c}function c(a,b){var c;if(null!=b)for(c in v)if(v.hasOwnProperty(c)&&b.call(a,c,v[c]))break}function d(b,c,d,e){for(var f,
g,h={},i=0,j=!0;j;){f={};j=!1;for(g in d)if(d.hasOwnProperty(g)&&!h[g])switch(h[g]=!0,e.call(b,g,v[g],i)){case w:f={};j=!1;break;case x:break;default:a(this,c,g,function(a){h[a]||(j=f[a]=!0)})}d=f;i+=1}}function e(a,b,c){null!=c&&null!=b&&(null!=v[b]&&null!=s[b])&&d(a,s,s[b],c)}function f(a,b,c){null!=c&&null!=b&&(null!=v[b]&&null!=u[b])&&d(a,u,u[b],c)}function g(b,c,d,e,f,g){var h,i,j,k;if(null!=g){c=[];i={};for(h in v)v.hasOwnProperty(h)&&(i[h]=d[h]||0,i[h]||c.push(h));for(k=0;0<c.length;){j=[];
d=0;for(f=c.length;d<f;d+=1){h=c[d];if(g.call(b,h,v[h],k)){j=[];break}k+=1;a(this,e,h,function(a){i[a]-=1;0==i[a]&&j.push(a)})}c=j}}}function h(a,b){g(a,u,t,s,q,b)}function i(a,b){g(a,s,q,u,t,b)}function j(a,b,c,d,e,f,g,h,i){var j=!1,k,l;if(null!=v[a]&&null!=g[a]){j=!0;if(i){i=0;for(k=b.length;i<k;i+=1)if(l=b[i],null==v[l]||null==g[a][l])j=!1}if(j&&(null!=d&&(v[c]=d),null!=v[c])){e[c]||(e[c]={},f[c]=0);g[c]||(g[c]={},h[c]=0);e[c][a]||(e[c][a]=!0,f[c]+=1);g[a][c]||(g[a][c]=!0,h[a]+=1);i=0;for(k=b.length;i<
k;i+=1)l=b[i],c!=l&&(null!=g[a][l]&&(delete g[a][l],h[a]-=1),null!=e[l][a]&&(delete e[l][a],f[l]-=1),e[l][c]||(e[l][c]=!0,f[l]+=1),g[c][l]||(g[c][l]=!0,h[c]+=1))}}return j}function k(a,b,c,d){return j(a,b,c,d,u,t,s,q,!0)}function l(){this.key=this.id="";this.children=[];this.childrenHash={};this.processed=!1}function m(a){this.items=[];this.difference=this.weight=0;0<arguments.length&&(this.difference=a)}function n(b){var c=primitives.common.graph(),d,e,f,g,h,i,j,k,l={};for(d in b)b.hasOwnProperty(d)&&
a(this,s,d,function(d){if(!l.hasOwnProperty(d)){l[d]=!0;e=[];a(this,u,d,function(a){e.push(a)});f=0;for(h=e.length;f<h-1;f+=1)if(i=e[f],b.hasOwnProperty(i))for(g=f+1;g<h;g+=1)if(j=e[g],b.hasOwnProperty(j)){k=Math.abs(b[i].children.length-b[j].children.length);var n=c.edge(i,j);null==n&&(n=new m(k),c.addEdge(i,j,n));n.items.push(d);n.weight+=1}}});return c}var p={},r={},s={},q={},u={},t={},v={},w=1,x=2;return{add:function(b,c,d){var e,f,g={};if(!b||0==b.length)b=[null];if(null==v[c]&&null!=d){v[c]=
d;d=0;for(e=b.length;d<e;d+=1)f=b[d],null==g[f]&&f!=c&&(g[f]=!0,null!=v[f]?(null==u[c]&&(u[c]={},t[c]=0),u[c][f]||(u[c][f]=!0,t[c]+=1),null==s[f]&&(s[f]={},q[f]=0),s[f][c]||(s[f][c]=!0,q[f]+=1)):(null==p[f]&&(p[f]={},r[f]=0),p[f][c]||(p[f][c]=!0,r[f]+=1)));null!=p[c]&&(s[c]=p[c],q[c]=r[c],delete p[c],delete r[c],a(this,s,c,function(a){null==u[a]&&(u[a]={},t[a]=0);u[a][c]||(u[a][c]=!0,t[a]+=1)}))}},adopt:function(a,b){var c,d,e;if(null!=v[b]){c=0;for(d=a.length;c<d;c+=1)if(e=a[c],null==u[b]&&(u[b]=
{},t[b]=0),e!=b&&null!=v[e])u[b][e]||(u[b][e]=!0,t[b]+=1),null==s[e]&&(s[e]={},q[e]=0),s[e][b]||(s[e][b]=!0,q[e]+=1);else throw"Item cannot be parent of itself and parent should exist in the structure!";}else throw"Child should be in hierarchy!";},bundleChildren:k,bundleParents:function(a,b,c,d){return j(a,b,c,d,s,q,u,t,!0)},optimizeReferences:function(b){var c={},d={},f={},g,h,i,k,m,p;if(null!=b){for(g in v)v.hasOwnProperty(g)&&(h=new l,a(this,s,g,function(a){h.children.push(a);h.childrenHash[a]=
!0}),h.children.sort(),h.id=g,h.key=h.children.join(","),f[h.id]=h);for(;!primitives.common.isEmptyObject(f);){i={};k=n(f);for(g in f)f.hasOwnProperty(g)&&(m=f[g],m.processed||(p=k.getSpanningTree(g,function(a,b){return a.weight>b.weight?1:a.weight==b.weight?b.difference-a.difference:-1}),p.loopLevels(this,function(a,g){f[a].processed=!0;p.loopChildren(this,a,function(h,m){var n=k.edge(a,h),p=null,r,A,L,y,H;f[h].processed=!0;if(1<n.weight){A=n.items.join(",");if(c.hasOwnProperty(A))p=c[A];else{r=
b();v[r.id]=r;p=new l;p.id=r.id;p.key=A;A=0;for(L=n.items.length;A<L;A+=1)p.children.push(n.items[A]),p.childrenHash[n.items[A]]=!0;p.children.sort();c[p.key]=p;d[p.id]=p;i[p.id]=p;y=p.children.slice(0);e(this,g.replacementItem||a,function(a){null!=d[a]&&!p.childrenHash[a]&&(H=!0,e(this,a,function(a){return!p.childrenHash[a]?(H=!1,w):x}),H&&y.push(a));return x});j(g.replacementItem||a,y,p.id,r,u,t,s,q,!1);if(1>=(q[a]||0))g.replacementItem=p.id}if(p.id!=h&&(y=p.children.slice(0),e(this,m.replacementItem||
h,function(a){null!=d[a]&&!p.childrenHash[a]&&(H=!0,e(this,a,function(a){return!p.childrenHash[a]?(H=!1,w):x}),H&&y.push(a));return x}),j(m.replacementItem||h,y,p.id,null,u,t,s,q,!1),1>=(q[h]||0)))m.replacementItem=p.id}})})));f=i}}},eliminateManyToMany:function(b){var c,d;for(c in s)s.hasOwnProperty(c)&&1<(q[c]||0)&&a(this,s,c,function(a){if(1<(t[a]||0))d=b(),k(c,[a],d.id,d)})},removeNode:function(b){null!=v[b]&&(a(this,s,b,function(a){delete u[a][b];t[a]-=1;t[a]||(delete u[a],delete t[a],null==
p[null]&&(p[null]={},r[null]=0),p[null][a]||(p[null][a]=!0,r[null]+=1))}),a(this,u,b,function(a){delete s[a][b];q[a]-=1;q[a]||(delete s[a],delete q[a])}),null!=p[null]&&null!=p[null][b]&&(delete p[null][b],r[null]-=1,r[null]||(delete p[null],delete r[null])),delete s[b],delete q[b],delete u[b],delete t[b],delete v[b])},removeRelation:function(a,c){var d=!1;null!=v[a]&&null!=v[c]&&(d=b(a,c)||b(c,a));return d},node:function(a){return v[a]},loop:c,loopLevels:function(b,c,d){function e(){this.items={};
this.minimumLevel=null}function f(a,b,c){var d=n[b];d||(d=new e,n[b]=d);d.addItemToLevel(a,c);x=null==x?c:Math.min(x,c);m[a]=c;k[a]=!0}var g=[],j={},k={},l=[],m={},n={},p,r,q,t,w,x=null;q=c?h:i;var J,D,y,F,B,E,K,I;e.prototype.addItemToLevel=function(a,b){var c=this.items[b];c?c.push(a):(c=[a],this.items[b]=c);this.minimumLevel=null==this.minimumLevel?b:Math.min(this.minimumLevel,b)};if(null!=d){q(this,function(a,b,c){g.push(a);j[a]=c});q=0;for(J=g.length;q<J;q+=1)if(p=g[q],null==k[p]){l.push(p);for(f(p,
q,0);0<l.length;){B=F=y=null;E=!c;K=[];p=0;for(t=l.length;p<t;p+=1)w=l[p],D=m[w],I=!1,c?(a(this,u,w,function(a){var b;if(!k[a]&&(I=!0,b=j[a],null==y||!E||y<b||y==b&&B>D-1))y=b,F=a,B=D-1,E=!0}),a(this,s,w,function(a){var b;if(!k[a]&&(I=!0,b=j[a],null==y||!E&&(y>b||y==b&&B<D+1)))y=b,F=a,B=D+1,E=!1})):(a(this,s,w,function(a){var b;if(!k[a]&&(I=!0,b=j[a],null==y||E||y<b||y==b&&B<D+1))y=b,F=a,B=D+1,E=!1}),a(this,u,w,function(a){var b;if(!k[a]&&(I=!0,b=j[a],null==y||E&&(y>b||y==b&&B>D-1)))y=b,F=a,B=D-1,
E=!0})),I&&K.push(w);null!=F&&(K.push(F),f(F,q,B));l=K}}l=!0;for(c=x;l;){p={};l=!1;for(r in n)if(n.hasOwnProperty(r)&&(q=n[r],t=q.items[q.minimumLevel-x+c],null!=t)){p[r]=q;l=!0;q=0;for(J=t.length;q<J;q+=1)if(w=t[q],d.call(b,w,v[w],c-x))return l=!1,!0}n=p;c+=1}}},loopTopo:h,loopTopoReversed:i,loopChildren:e,loopParents:f,findLargestRoot:function(){var a=null,b,c={},d={},e;b=0;i(this,function(g,h){c.hasOwnProperty(g)||(c[g]={},d[g]=0);c[g][g]=!0;d[g]+=1;e=!0;f(this,h.id,function(a){var b,f;e=!1;c.hasOwnProperty(a)||
(c[a]={},d[a]=0);if(!d[a]&&1==t[g])c[a]=c[g],d[a]=d[g];else for(f in b=c[g],b)b.hasOwnProperty(f)&&(c[a][f]=!0,d[a]+=1);return x});e&&d[g]>b&&(b=d[g],a=g)});return a},hasNodes:function(){return!primitives.common.isEmptyObject(v)},hasCommonChild:function(b){var c=!1,d,e,f,g,h,i,j;d={};g=f=0;for(h=b.length;g<h;g+=1)i=b[g],null!=v[i]&&!d[i]&&(d[i]=!0,f+=1);e={};for(i in d)d.hasOwnProperty(i)&&a(this,s,i,function(a){e[a]=e[a]?e[a]+1:1});for(j in e)if(e.hasOwnProperty(j)&&null!=u[j]&&(t[j]||0)==e[j]&&
e[j]==f){c=!0;break}return c},loopNeighbours:function(a,b,c){var d={};null!=c&&(e(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,1)&&(d[b]=x,f(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,e,2)&&(d[b]=x));return d[b]})));return d[b]}),f(this,b,function(b,f){d.hasOwnProperty(b)||(d[b]=null,c.call(a,b,f,1)&&(d[b]=x,e(this,b,function(b,e){d.hasOwnProperty(b)||(d[b]=!0,c.call(a,b,e,2)&&(d[b]=x));return d[b]})));return d[b]}))},validate:function(b){function d(a){var b=
0,c;if(null!=a)for(c in a)a.hasOwnProperty(c)&&(b+=1);return b}var e,f;c(this,function(c){a(this,s,c,function(a){if(!u.hasOwnProperty(a)||!u[a].hasOwnProperty(c))return null!=b&&(b.message="Child #"+a+" does not reference parent #"+c),!1});a(this,u,c,function(a){if(!s.hasOwnProperty(a)||!s[a].hasOwnProperty(c))return null!=b&&(b.message="Parent #"+a+" does not reference child #"+c),!1})});for(e in u)if(u.hasOwnProperty(e)){if((t[e]||0)!=d(u[e]))return null!=b&&(b.message="Parents count for item #"+
e+" missmatch."),!1;if(u.hasOwnProperty(e)&&!v.hasOwnProperty(e))return null!=b&&(b.message="Orphant parents for item #"+e),!1}for(f in s)if(s.hasOwnProperty(f)){if((q[f]||0)!=d(s[f]))return null!=b&&(b.message="Children count for item "+f+" missmatch."),!1;if(s.hasOwnProperty(f)&&!v.hasOwnProperty(f))return null!=b&&(b.message="Orphant children of item "+f),!1}for(f in p)if(p.hasOwnProperty(f)){if((r[f]||0)!=d(p[f]))return null!=b&&(b.message="Root children count for item @"+f+" missmatch."),!1;
...
primitives.common.graph=function(){var a={};return{addEdge:function(b,c,d){if((null==a[b]||null==a[b][c])&&null!=d)null==a[b]&&(a[b]={}),a[b][c]=d,null==a[c]&&(a[c]={}),a[c][b]=d},edge:function(b,c){var d=null;null!=a[b]&&a[b][c]&&(d=a[b][c]);return d},getSpanningTree:function(b,c){var d=primitives.common.tree(),e={},f,g=[],h,i={},j,k,l,m,n,p,r;e[b]=!0;j=1;i[b]=null;for(d.add(null,b.toString(),{});0<j;){g=[];m=l=k=null;for(f in e)if(e.hasOwnProperty(f)){n=a[f];h=!1;for(p in n)if(n.hasOwnProperty(p)&&
!i.hasOwnProperty(p)&&(r=n[p],h=!0,!l||0<=c(r,l)))k=p,l=r,m=f;h||g.push(f)}if(null==k)break;else e[k]=!0,j+=1,i[k]=m,d.add(m,k,{});h=0;for(k=g.length;h<k;h+=1)delete e[g[h]],j-=1}return d},getGrowthSequence:function(b){var c=[],d,e={},f;d=[];var g,h={},i=0,j,k,l,m,n,p;if(null!=b){d=null;l=0;m=null;for(g in a)if(a.hasOwnProperty(g)){k=a[g];l=0;for(j in k)k.hasOwnProperty(j)&&(l+=b(k[j]));if(l>m||null==m)d=g,m=l}if(null!=d){c.push(d);e[d]=!0;i+=1;for(h[d]=null;0<i;){d=[];k=j=null;l={};for(f in e)if(e.hasOwnProperty(f)){m=
a[f];g=!1;for(n in m)if(m.hasOwnProperty(n)&&!h.hasOwnProperty(n)&&(p=b(m[n]),g=!0,null==l[n]&&(l[n]=0),l[n]+=p,!k||l[n]>k))j=n,k=l[n];g||d.push(f)}if(null==j)break;else e[j]=!0,i+=1,h[j]=!0,c.push(j);g=0;for(j=d.length;g<j;g+=1)delete e[d[g]],i-=1}}}return c},getShortestPath:function(b,c,d){var e={},f={},g={},h,i,j,k,l;e[b]=!0;h=1;for(f[b]=0;0<h;){i=b=null;for(j in e)e.hasOwnProperty(j)&&(null==i?(b=j,i=f[j]):i>f[j]&&(b=j,i=f[j]));k=a[b];for(j in k)k.hasOwnProperty(j)&&(l=i+(null!=d?d(k[j],b,j):
...
primitives.famdiagram.Controller.prototype._virtualCreateOrgTree=function(){var a,b,c,d,e,f,g,h,i=[],j,k,l,m,n,p,r,s,q=this,u,t,v;this._defaultLabelAnnotationTemplateName=this.widgetEventPrefix+"DefaultLabelAnnotationTemplate";primitives.common.isNullOrEmpty(this.options.defaulLabelAnnotationTemplate)||(this._defaultLabelAnnotationTemplateName=this.options.defaulLabelAnnotationTemplate);this.showElbowDots=this.showInvisibleSubTrees=!0;this._configs=primitives.common.family();this._logicalFamily=primitives.common.family();
this.itemByChildrenKey={};this._orgPartners={};this._families=[];this._orgTree=primitives.common.tree();this.maximumFamItemId=0;this.maximumLevel=this.minimumLevel=null;if(0<this.options.items.length){k=[];a=0;for(b=this.options.items.length;a<b;a+=1)f=this.options.items[a],null!=f&&(this._configs.add(f.parents,f.id,f),d=new primitives.famdiagram.FamilyItem({id:f.id,itemConfig:f,isActive:f.hasOwnProperty("isActive")?f.isActive:!0}),this._logicalFamily.add(f.parents,d.id,d),c=d.itemConfig.spouses,
null!=c&&0<c.length&&k.push(d),c=parseInt(f.id,10),this.maximumFamItemId=Math.max(isNaN(c)?0:c,this.maximumFamItemId));if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";t=this._logicalFamily.clone();this._logicalFamily.loopTopo(this,function(a){t.removeNode(a)});if(t.hasNodes()){a=0;for(b=this.options.items.length;a<b;a+=1)if(f=this.options.items[a],null!=t.node(f.id)){s=[];t.loopParents(this,f.id,function(a){s.push(a);return t.SKIP});c=0;for(d=s.length;c<
d;c+=1)t.removeRelation(s[c],f.id),this._logicalFamily.removeRelation(s[c],f.id);this.maximumFamItemId+=1;e=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:q._debug,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake parent #"+q.maximumFamItemId,description:"This is fake parent item was created by loops reversal."}});this._logicalFamily.add([],e.id,e);this._logicalFamily.adopt([e.id],f.id);c=0;for(d=s.length;c<d;c+=1)this.maximumFamItemId+=
1,f=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:q._debug,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+q.maximumFamItemId,description:"This is fake child item was created by loops reversal."}}),this._logicalFamily.add([e.id,s[c]],f.id,f);v=[];t.loopTopo(this,function(a){v.push(a)});c=0;for(d=v.length;c<d;c+=1)t.removeNode(v[c])}}a=0;for(b=k.length;a<b;a+=1)f=k[a],c=f.itemConfig.spouses.slice(0),c.push(f.id),this._logicalFamily.hasCommonChild(c)||
(this.maximumFamItemId+=1,f=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:q._debug,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0,itemConfig:{title:"fake child #"+q.maximumFamItemId,description:"This is fake child keeps spouses together."}}),this._logicalFamily.add(c,f.id,f));if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";this._logicalFamily.loopLevels(this,1==this.options.groupByType,function(a,b,c){b.level=
c});this._addLabelAnnotations(this._logicalFamily,this.options.annotations);if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";this._logicalFamily.optimizeReferences(function(){q.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,isVisible:q._debug,isActive:!1,itemConfig:{title:"bundle #"+q.maximumFamItemId,description:" This item was created by references optimizer."},levelGravity:2})});if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";
this._logicalFamily.eliminateManyToMany(function(){q.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,isVisible:q._debug,isActive:!1,itemConfig:{title:"dummy #"+q.maximumFamItemId,description:"This is item used to eliminate M:M relations."},levelGravity:2})});if(this._debug&&!this._logicalFamily.validate())throw"References are broken in family structure!";this._resortItemsBylevels(this._logicalFamily);this._debug&&this._validate(this._logicalFamily,!1);this._fillInItems(this._logicalFamily,
function(){q.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,levelGravity:2,isVisible:q._debug,isActive:!1,itemConfig:{title:"extension #"+q.maximumFamItemId,description:"This is item used to fill gaps in levels."}})});this._debug&&this._validate(this._logicalFamily,!0);c=this._logicalFamily.clone();this.properties="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");
this.defaultItemConfig=new primitives.famdiagram.ItemConfig;a=null;for(b=0;null!=(a=c.findLargestRoot());)k=new primitives.famdiagram.Family(b),this._extractOrgChart(a,this._logicalFamily,c,k),this._families.push(k),b+=1;i=[];j={};if(0<this._families.length){e=primitives.common.graph();a=0;for(b=this._families.length;a<b;a+=1){k=this._families[a];c=0;for(d=k.links.length;c<d;c+=1)f=k.links[c],g=this._logicalFamily.node(f.fromItem).familyId,h=this._logicalFamily.node(f.toItem).familyId,g!=h&&(e.addEdge(g,
h,{weight:0}),e.edge(g,h).weight+=1),this._families[h].backLinks.push(new primitives.famdiagram.FamLink(f.toItem,f.fromItem))}for(;i.length<this._families.length;){a=0;for(b=this._families.length;a<b;a+=1)k=this._families[a],j.hasOwnProperty(k.id)||(r=e.getSpanningTree(k.id,function(a,b){return a.weight-b.weight}),null!=r.node(k.id)?(r.loopPostOrder(this,function(a,b,c){var b=this._families[a],d=this._families[c],e=[],f=this;null!=c&&(d.familyPriority+=b.familyPriority);e=[];r.loopChildren(this,a,
function(a){e.push(a)});e.sort(function(a,b){return f._families[a].familyPriority-f._families[b].familyPriority});r.arrangeChildren(a,e)}),r.loopPreOrder(this,function(a){i.push(a);j[a]=!0})):(i.push(k.id),j[k.id]=!0))}}this.maximumFamItemId+=1;u=this._createOrgItem(this.maximumFamItemId,null,null,this.minimumLevel-1,null);u.hideParentConnection=!0;u.hideChildrenConnection=!0;u.title="internal root";u.isVisible=!1;u.isActive=!1;u.childIndex=0;e={};a=0;for(b=i.length;a<b;a+=1){k=this._families[i[a]];
h={};n=u;p=0;d=k.links.concat(k.backLinks);for(c=0;c<d.length;c+=1)f=d[c],g=this._orgTree.node(f.toItem),this._orgTree.node(f.fromItem),!0==e[g.familyId]&&(l=k.items[0],m=g,this._orgTree.loopParents(this,m.id,function(a,b){m=b;if(b.level<l.level)return!0}),h[m.id]=h.hasOwnProperty(m.id)?h[m.id]+1:1,p<h[m.id]&&(n=m,p=h[m.id]));this._attachFamilyToOrgChart(n,k);e[k.id]=!0}a=this._getExtraGravity();b=this._getGrandChildren();this._balanceOrgTree(this._orgTree,a,b)}};
primitives.famdiagram.Controller.prototype._validate=function(a,b){if(!a.validate())throw"Family structure failed to pass validation!";a.loop(this,function(c,d){a.loopChildren(this,c,function(c,f,g){if(0<g)return a.BREAK;if(null===f.level||null===d.level||(b?f.level!=d.level+1:f.level<=d.level))throw"Family tree is broken. Children/Parents or levels mismatch!";})})};
primitives.famdiagram.Controller.prototype._addLabelAnnotations=function(a,b){var c=primitives.common.graph(),d={},e,f,g,h,i=this;if(0<b.length){h=0;for(e=b.length;h<e;h+=1)f=b[h],3==f.annotationType&&(d.hasOwnProperty(f.fromItem)?d[f.fromItem].push(f):(d[f.fromItem]=[f],a.loopChildren(this,f.fromItem,function(b){c.addEdge(f.fromItem,b,new primitives.famdiagram.EdgeItem(f.fromItem,f.fromItem,b,b));return a.SKIP}),a.loopParents(this,f.fromItem,function(b){c.addEdge(b,f.fromItem,new primitives.famdiagram.EdgeItem(b,
b,f.fromItem,f.fromItem));return a.SKIP})));for(g in d)if(d.hasOwnProperty(g)){e=d[g];e.sort(function(a,b){return b.toItems.length-a.toItems.length});for(h=0;h<e.length;h+=1)f=e[h],this._addLabelAnnotation(a,c,f.fromItem,f.toItems,function(){i.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:i.maximumFamItemId,isVisible:!0,isActive:!1,itemConfig:f})})}}};
primitives.famdiagram.Controller.prototype._addLabelAnnotation=function(a,b,c,d,e){var f,g=!0,h=null,i,j,k,l=[];j=0;for(k=d.length;j<k;j+=1)if(i=d[j],f=b.edge(c,i),null!=f){if(null==h)h=f.getFar(i);else if(h!=f.getFar(i)){g=!1;break}l.push(f.getNear(i))}else{g=!1;break}if(g&&(e=e(),a.bundleChildren(h,l,e.id,e)?(e.levelGravity=1,g=!0):a.bundleParents(h,l,e.id,e)&&(e.levelGravity=2,g=!0),g)){j=0;for(k=d.length;j<k;j+=1)i=d[j],f=b.edge(c,i),f.setFar(i,e.id)}};
...
primitives.famdiagram.Controller.prototype._balanceOrgTree=function(a,b,c){var d,e,f,g,h,i,j,k,l,m,n;a.loopLevels(this,function(p,r){var s=primitives.common.graph(),q={},u=null,t;j=[];a.loopChildren(this,r.id,function(c,f,g){var j;null==u&&(u=f);q[f.id]={};if(b.hasOwnProperty(f.id))for(j in i=b[f.id],i)if(i.hasOwnProperty(j)){m=i[j];q[f.id][j]={};d=0;for(e=m.length;d<e;d+=1)h=m[d],t=h.commonParent==r.id?h.toParent:a.node(h.fromParent).childIndex<a.node(h.toParent).childIndex?"__right__":"__left__",
f.id!=t&&(s.addEdge(f.id,t,{weight:0}),s.edge(f.id,t).weight+=1,null==q[f.id][j][t]&&(q[f.id][j][t]=0),q[f.id][j][t]+=1)}0<g&&s.addEdge(f.id,u.id,{weight:0})});if(null!=u){n=s.getGrowthSequence(function(a){return a.weight});0==n.length&&(n=[u.id]);k=this._balanceItems(n,"__left__","__right__",q,c);f=0;for(g=k.length;f<g;f+=1)l=a.node(k[f]),l.childIndex=f,j.push(l.id)}a.arrangeChildren(r.id,j)})};
primitives.famdiagram.Controller.prototype._balanceItems=function(a,b,c,d,e){var f=[],g,h,i,j,k,l,m,n,p,r,s,q,u,t,v,w,x,z,G,C;h=new primitives.famdiagram.Slots;h.add(new primitives.famdiagram.Slot(b));h.add(new primitives.famdiagram.Slot(null));h.add(new primitives.famdiagram.Slot(c));i=0;h.loop(function(a){i+=1;a.position=i});for(g=0;g<a.length;g+=1)if(j=a[g],j!=b&&j!=c)for(x in p=n=m=l=k=null,h.loop(function(a){var b,c,f,g;if(null==a.itemId){t=e[j];u=q=s=r=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&
(t&&null!=t[b]&&(r+=a.crossings[b]*t[b]),u+=a.crossings[b]);for(b in d[j])if(d[j].hasOwnProperty(b))for(c in f=d[j][b],f)f.hasOwnProperty(c)&&(g=h.getSlot(c),null!=g&&(g.position<a.position?(r+=(a.left[b]||0)-(g.left[b]||0),q+=Math.abs(g.balance+1)):(r+=(a.right[b]||0)-(g.right[b]||0),q+=Math.abs(g.balance-1)),s+=Math.abs(g.position-a.position)));if(null==l||l>r||l==r&&(m>s||m==s&&(n>q||n==q&&p>u)))l=r,k=a,m=s,n=q,p=u}}),v=k.clone(),w=k.clone(),w.itemId=j,h.insertBefore(k,v),h.insertBefore(k,w),i=
w.position=0,h.loop(function(a){var b,c;if(a.id!=w.id){c=e[j];for(b in c)c.hasOwnProperty(b)&&(a.left[b]=a.left[b]?a.left[b]+c[b]:c[b]);i+=1;a.position=i}},w),i=0,h.backwardLoop(function(a){var b,c;if(a.id!=w.id){c=e[j];for(b in e[j])e[j].hasOwnProperty(b)&&(a.right[b]=a.right[b]?a.right[b]+c[b]:c[b]);i-=1;a.position=i}},w),d[j])if(d[j].hasOwnProperty(x))for(G in z=d[j][x],z)z.hasOwnProperty(G)&&(C=h.getSlot(G),null!=C&&(0>C.position?(C.balance+=1,w.balance-=1,h.backwardLoop(function(a){if(a.id!=
...
primitives.famdiagram.Controller.prototype._extractOrgChart=function(a,b,c,d){var e,f=[],g,h,a=this._logicalFamily.node(a),f=this._createOrgItem(a.id,null,d.id,a.level,a.itemConfig);f.hideParentConnection=!0;f.isVisible=a.isVisible;f.isActive=a.isActive;f.hideParentConnection=a.hideParentConnection;f.hideChildrenConnection=a.hideChildrenConnection;d.items.push(f);c.removeNode(a.id);a.familyId=d.id;for(f=this._extractChildren(a,b,c,d);0<f.length;){g=[];a=0;for(e=f.length;a<e;a+=1)h=f[a],g=g.concat(this._extractChildren(h,
b,c,d));f=g}};
primitives.famdiagram.Controller.prototype._extractChildren=function(a,b,c,d){var e=[],f={},g,h,i=[],j="",j=null,k;b.loopChildren(this,a.id,function(a,c,d){if(0<d)return b.BREAK;i.push(a)});i.sort();j=i.toString();null!=this.itemByChildrenKey[j]?(j=this.itemByChildrenKey[j],null==this._orgPartners[j.id]&&(this._orgPartners[j.id]=[]),this._orgPartners[j.id].push(a.id),b.loopChildren(this,a.id,function(c,e,f){if(0<f)return b.BREAK;d.links.push(new primitives.famdiagram.FamLink(a.id,c))})):(""!=j&&(this.itemByChildrenKey[j]=
a),b.loopChildren(this,a.id,function(i,j,n){if(0<n)return b.BREAK;null!=c.node(j.id)&&(g=[],b.loopChildren(this,j.id,function(a,c,d){if(0<d)return b.BREAK;g.push(a)}),g.sort(),h=g.toString(),null!=f[h]?(k=this._createOrgItem(j.id,f[h].id,d.id,j.level,j.itemConfig),k.hideParentConnection=j.hideParentConnection,k.hideChildrenConnection=j.hideChildrenConnection,k.isVisible=j.isVisible,k.isActive=j.isActive,k.itemType=6,d.items.push(k)):(""!=h&&(f[h]=j),k=this._createOrgItem(j.id,a.id,d.id,j.level,j.itemConfig),
k.hideParentConnection=j.hideParentConnection,k.hideChildrenConnection=j.hideChildrenConnection,k.isVisible=j.isVisible,k.isActive=j.isActive,d.items.push(k),e.push(j)),c.removeNode(j.id),j.familyId=d.id)}));return e};
...
primitives.orgdiagram.Controller.prototype._virtualCreateOrgTree=function(){var a,b,c,d,e,f,g,h,i,j,k;this._configs=primitives.common.tree();this._orgTree=primitives.common.tree();if(null!=this.options.items&&0<this.options.items.length){i="title description image itemTitleColor groupTitle groupTitleColor isVisible isActive hasSelectorCheckbox hasButtons itemType adviserPlacementType childrenPlacementType templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");j=
new primitives.orgdiagram.ItemConfig;d=k=0;for(e=this.options.items.length;d<e;d+=1)if(c=this.options.items[d],null!=c.id){this._configs.add(c.parent,c.id,c);a=new primitives.orgdiagram.OrgItem;a.id=c.id;f=parseInt(c.id,10);k=Math.max(isNaN(f)?0:f,k);a.context=c;f=0;for(g=i.length;f<g;f+=1)h=i[f],a[h]=void 0!==c[h]?c[h]:j[h];this._orgTree.add(c.parent,a.id,a)}k+=1;b=new primitives.orgdiagram.OrgItem;b.id=k;b.hideParentConnection=!0;b.hideChildrenConnection=!0;b.title="internal root";b.isVisible=!1;
...
primitives.orgdiagram.Controller.prototype._virtualShowCursorNeighbours=function(){if(null!==this._cursorTreeItem){0===this._cursorTreeItem.visibility&&(this._cursorTreeItem.visibility=1);switch(this.options.selectionPathMode){case 0: this._navigationFamily.loop(this,function(a,b,c){b.visibility=2;});break;case 1:this._navigationFamily.loopParents(this,this._cursorTreeItem.id,function(a,b){0===b.visibility&&(b.visibility=1)})}this._navigationFamily.loopNeighbours(this,this._cursorTreeItem.id,function(a,b){b.visibility=1;return!0})}};
